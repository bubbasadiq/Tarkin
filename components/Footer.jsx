...
export default function Footer() {
  return (
    <footer className="bg-[#07352E] pt-10 px-2" aria-labelledby="footer-heading">
        ...
        <div className="xl:grid xl:grid-cols-2 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0 ml-auto mr-5">
                <h3 className="text-base font-serif font-bold leading-10">About Us</h3>
                <h3 className="text-base font-serif font-bold leading-10">Contact Us</h3>
                <h3 className="text-base font-serif font-bold leading-10">FAQs</h3>
              </div>
          </div>
        </div>
        <div className="mt-8 pt-8 md:flex md:items-center md:justify-between">
        <div className="flex items-center space-x-2 mt-2">
        <p className="mt-8 text-base font-sans font-normal md:order-1 md:mt-0">
            &copy; 2022 Tarkin. Copyright and rights reserved
          </p>
